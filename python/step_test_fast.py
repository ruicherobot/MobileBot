...
# qs = 1.0 # 1.0 is fast, 4.0 is slow

# drive_straight_command = mbot_motor_command_t()
# drive_straight_command.trans_v = 0.8 / qs
# drive_straight_command.angular_v = 0.0
# drive_sstraight_command = mbot_motor_command_t()
# drive_sstraight_command.trans_v = 0.8 / qs / 4
# drive_sstraight_command.angular_v = 0.0
...
# drive_curve_left_command.angular_v = 3.1416 / qs * 1.8
...
# drive_curve_right_command.angular_v = - 3.1416 / qs * 1.8
...
# lc.publish("MBOT_MOTOR_COMMAND", drive_straight_command.encode())
# sleep(0.3625 * qs)
# lc.publish("MBOT_MOTOR_COMMAND", drive_sstraight_command.encode())
# sleep(ss * qs) #30 cm
...
drive_curve_left_command = mbot_motor_command_t()
drive_curve_left_command.trans_v = 0.934 / qs #contiune straight while going left
drive_curve_left_command.angular_v = 3.1416 / qs * 1.4 #might need 1.2?

drive_curve_right_command = mbot_motor_command_t()
drive_curve_right_command.trans_v = 0.934 / qs #contiune straight while going right
drive_curve_right_command.angular_v = - 3.1416 / qs * 1.4


# lc.publish("MBOT_MOTOR_COMMAND", drive_curve_left_command.encode()) #U-turn
# sleep(5 * qs)
# lc.publish("MBOT_MOTOR_COMMAND", drive_curve_right_command.encode())
# sleep(5 * qs)
...
lc.publish("MBOT_MOTOR_COMMAND", drive_curve_right_command.encode()) #BIG -- U-turn
sleep(0.2 * qs)
